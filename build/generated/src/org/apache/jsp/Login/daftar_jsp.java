...
public final class daftar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <form class=\"form-horizontal\" role=\"form\" action=\"OlahAddPendaftaran.jsp\">\n");
      out.write("<!--                        <div class=\"form-group\">\n");
      out.write("\t\t\t<label for=\"inputname\" class=\"col-sm-2 control-label\">ID</label>\n");
      out.write("\t\t\t<div class=\"col-sm-10\">\n");
      out.write("                            <input type=\"text\" class=\"form-control\" id=\"inputname\" placeholder=\"XXXXX\" name=\"id\" disabled=\"\">\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t<div class=\"col-sm-10\">\n");
      out.write("                            <input type=\"text\" class=\"form-control\" id=\"inputname\" placeholder=\"Nama\" name=\"nama\" required />\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\t<!-- End of /.form-group -->\n");
      out.write("                                        \n");
      out.write("                        <div class=\"form-group\">\n");
      ...
      out.write("                                    <select class=\"form-control\" name=\"jk\">\n");
      ...
      out.write("\t\t\t\t\t\t\t    <div class=\"col-sm-10\">\n");
      out.write("\t\t\t\t\t\t\t      \t<input type=\"text\" class=\"form-control\" id=\"inputwebsite\" placeholder=\"No Hp\" name=\"nohp\" required />\n");
      out.write("\t\t\t\t\t\t\t    </div>\n");
      out.write("\t\t\t\t\t\t  \t</div>\t<!-- End of /.form-group -->\n");
      out.write("                                                        \n");
      out.write("\t\t\t\t\t\t  \t<div class=\"form-group\">\n");
      ...
      out.write("\t\t\t\t\t\t\t    <div class=\"col-sm-10\">\n");
      out.write("                                                                <textarea class=\"form-control\" id=\"inputmessage\"  rows=\"3\" placeholder=\"Alamat\" name=\"alamat\" required /></textarea>\n");
      out.write("\t\t\t\t\t\t\t    </div>\n");
      out.write("\t\t\t\t\t\t  \t</div>\t<!-- End of /.form-group -->\n");
      out.write("                                                        <div class=\"form-group\">\n");
      out.write("                                                        <label for=\"inputwebsite\" class=\"col-sm-2 control-label\">Username</label>\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"col-sm-10\">\n");
      out.write("                                                                <input type=\"text\" class=\"form-control\" id=\"inputwebsite\" placeholder=\"Username\" name=\"username\" required />\n");
      out.write("\t\t\t\t\t\t\t    </div>\n");
      out.write("\t\t\t\t\t\t  \t</div>\t<!-- End of /.form-group -->\n");
      out.write("                                                        <div class=\"form-group\">\n");
      out.write("                                                        <label for=\"inputwebsite\" class=\"col-sm-2 control-label\">Password</label>\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"col-sm-10\">\n");
      out.write("                                                                <input type=\"text\" class=\"form-control\" id=\"inputwebsite\" placeholder=\"Password\" name=\"password\" required />\n");
      out.write("\t\t\t\t\t\t\t    </div>\n");
      out.write("\t\t\t\t\t\t  \t</div>\t<!-- End of /.form-group -->\n");
      out.write("\t\t\t\t\t\t  \t\t\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
