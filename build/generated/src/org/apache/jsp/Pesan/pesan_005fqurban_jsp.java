...
public final class pesan_005fqurban_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                    <label for=\"select-box1\" class=\"label select-box1\"><span class=\"label-desc\"> Pilih Hewan Qurban </span></label>\n");
      out.write("                                                <select id =\"select-box1\" class=\"select\">\n");
      out.write("                                                    <option value=\"sapi\"> Sapi </option>\n");
      out.write("                                                    <option value=\"kerbau\"> Kerbau </option>\n");
      out.write("                                                    <option value=\"kerbau\"> Kambing </option>\n");
      out.write("                                                </select>\n");
      out.write("                                </div>\n");
      out.write("                        </div>\n");
      ...
      out.write("                                                <select id =\"select-box1\" class=\"select\">\n");
      out.write("                                                    <option value=\"sapi\"> 230 - 250 kg </option>\n");
      out.write("                                                    <option value=\"kerbau\"> 330 - 350 kg</option>\n");
      out.write("                                                    <option value=\"kerbau\"> 480 - 500 kg </option>\n");
      out.write("                                                </select>\n");
      out.write("                                </div>\n");
      out.write("                        </div>\n");
      out.write("\t\t\t</div>\t<!-- End of /.form-group -->\n");
      ...
      out.write("\t\t\t\t\t\t  \t</div>\t<!-- End of /.form-group -->\n");
      out.write("                                                        <div class=\"form-group\">\n");
      out.write("                                                        <label for=\"inputwebsite\" class=\"col-sm-2 control-label\">Metode Pembayaran</label>\n");
      out.write("\t\t\t\t\t\t\t    <div class=\"col-sm-10\">\n");
